...
function TeacherSettings() {
  ...
  const handleConfirmOtp = async () => {
    ...
    try {
      ...
      if (result.status === "success") {
        ...
        showCustomAlert(result.message || "Invalid OTP", "error");
      }
    } catch (error) {
  ...
  return (
    <div className="settings-wrapper">
      ...
      <main className="settings-content">
        ...
        <div className="account-header">
          <div
            ...
            style={{
              ...
              backgroundColor: settings.avatar ? "transparent" : "#ccc"
            }}
          ></div>
          <div>
        ...
        <div className="profile-grid">
          <div>
            ...
            <p>{settings.firstName || "Not set"}</p>
          </div>
          <div>
            <label>Last Name</label>
            <p>{settings.lastName || "Not set"}</p>
          </div>
          <div>
                ...
                <label htmlFor="avatarUpload">
                  <div
                    ...
                    style={{
                      ...
                      backgroundSize: "cover",
                      backgroundPosition: "center",
                      backgroundColor: editSettings.avatar ? "transparent" : "#ccc"
                    }}
                  ></div>
                </label>
                <input
      ...
      {/* Password Modal - Modern Design with Old Password */}
      {showPassword &&
