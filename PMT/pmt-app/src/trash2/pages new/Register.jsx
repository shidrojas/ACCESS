...
function Register() {
  ...
  try {
    const res = await fetch("http://localhost/PMT/api/register.php", {
      method: "POST",
      headers: {
  ...
  try {
    const res = await fetch("http://localhost/PMT/api/authentication/verify_otp.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  try {
    const res = await fetch("http://localhost/PMT/api/authentication/cancel_registration.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  try {
    const res = await fetch("http://localhost/PMT/api/authentication/resend_otp.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
