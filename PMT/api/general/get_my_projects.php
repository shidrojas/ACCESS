...
// IMPORTANT: Only fetch projects where the user has approved roles (Host, Co-Host, Member)
// Exclude 'Pending' role
$sql = "
    SELECT 
        p.ProjectID,
        p.ProjectName,
    ...
    AND pm.Role IN ('Host', 'Co-Host', 'Member')  -- Only approved roles
";
