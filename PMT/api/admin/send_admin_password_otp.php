...
// Send email using PHPMailer (same as your forgot_pass.php)
...
try {
    ...
    $mail->Subject = "Admin Password Change OTP";
    $mail->isHTML(true);
    $mail->Body = "
    <html>
    <head>
    ...
    <body>
        <h2>Hello $name,</h2>
        <p>You requested to change your admin password. Your OTP code is:</p>
